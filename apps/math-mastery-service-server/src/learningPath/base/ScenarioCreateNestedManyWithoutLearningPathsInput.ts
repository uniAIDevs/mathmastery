...
@InputType()
class ScenarioCreateNestedManyWithoutLearningPathsInput {
...
export { ScenarioCreateNestedManyWithoutLearningPathsInput as ScenarioCreateNestedManyWithoutLearningPathsInput };
